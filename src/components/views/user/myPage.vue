       ...
       <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <input type="button" @click="openPhone" class="btn btn-outline-primary btn-default btn-sm mt-3" value="전화번호 변경하기">
                    ...
                    <input type="button" @click="sample6_execDaumPostcode" class="btn btn-outline-primary btn-default btn-sm mt-2" value="우편번호 찾기">
                    <input type="button" @click="updateAddress" id="updateAddressButton" class="btn btn-outline-primary btn-default btn-sm mt-2" value="주소변경하기" disabled>
                    ...
                    <input type="button" @click="updatePwd"  class="btn btn-outline-primary btn-default btn-sm mt-2" value="비밀번호 수정">                    
                </div>
                <div class="col">
                </div>
            </div>
