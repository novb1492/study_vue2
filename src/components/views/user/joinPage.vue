       ...
       <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <input type="button" id="sendPhoneButton" class="btn btn-outline-primary" @click="sendPhone" value="인증번호전송">
                    <input type="text" id="randnum" class="form-control joinInput " placeholder="인증번호를 입력해주세요">
                    <input type="button" id="sendRandButton" class="btn btn-outline-primary" @click="sendRand" value="확인" disabled>
                    <br>
