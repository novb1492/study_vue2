  ...
  <div v-if="useHeader()">
    <div class="fade-in-box">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <b-nav-item href="/shopMainPage?kind=coffee">Shop</b-nav-item>
          <b-nav-item href="/" disabled>nothing</b-nav-item>
        </b-navbar-nav>
   ...
   name:'header',
    ...
    methods :{
      ...
      useHeader(){
        ...
        if(uri=='/joinPage'||uri=='/loginPage'||uri=='/myPage'||uri=='/findPwdPage'||uri=='/findEmailPage'||uri=='/changePhonePage'||uri=='/showItemPage'){
           showOrNot= false;
        }else{
          showOrNot=true;
          this.doLogin();
